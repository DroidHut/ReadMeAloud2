...
public class ReaderActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (bookName.equals("One")) {
                BOOK_NAME = "books/test.epub";
            } else {
                BOOK_NAME = "books/TheSilverChair.epub";
            }
        ...
        CustomAdapter adapter = new CustomAdapter(this, R.layout.list, R.id.title_book, contentDetails);
    ...
    private class CustomAdapter extends ArrayAdapter<RowData> {
        ...
        private CustomAdapter(Context context, int resource,
        ...
        private class ViewHolder {
            ...
            private TextView getTitle() {
                if (null == titleHolder)
                    titleHolder = row.findViewById(R.id.title_book);
                return titleHolder;
            }
        }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent intent = new Intent(ReaderActivity.this, DisplayActivity.class);
        try {
